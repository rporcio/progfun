...
$c_Lcalculator_Calculator$.prototype.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D = (function(expr, references, referenced) {
  _evalWithReferences: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if (referenced.contains__O__Z(name)) {
        return (NaN)
      } else {
        var temp$expr = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
        var temp$referenced = $as_sci_Set(referenced.$$plus__O__sc_Set(name));
        expr = temp$expr;
        referenced = temp$referenced;
        continue _evalWithReferences
      }
    } else if ($is_Lcalculator_Plus(x1)) {
      var x4 = $as_Lcalculator_Plus(x1);
      var a = x4.a$2;
      var b = x4.b$2;
      return (this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a, references, referenced) + this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b, references, referenced))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      return (this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a$2, references, referenced) - this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b$2, references, referenced))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      return (this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a$3, references, referenced) * this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b$3, references, referenced))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      return (this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(a$4, references, referenced) / this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(b$4, references, referenced))
    } else {
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  return this.evalWithReferences$1__p1__Lcalculator_Expr__sci_Map__sci_Set__D(expr, references, $as_sci_Set($m_s_Predef$().Set$2.apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())))
});
...
$c_Lcalculator_Polynomial$.prototype.computeDelta__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal__Lcalculator_Signal = (function(a, b, c) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(a$1, b$1, c$1) {
    return (function() {
      var a$2 = $uD(b$1.apply__O());
      return ($uD($g["Math"]["pow"](a$2, 2.0)) - ((4 * $uD(a$1.apply__O())) * $uD(c$1.apply__O())))
    })
  })(a, b, c));
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__T2 = (function(x0$1) {
  if ((x0$1 !== null)) {
    ...
    var expr = $as_Lcalculator_Signal(x0$1.$$und2$f);
    ...
    var y = new $c_Lcalculator_Var().init___F0(expr$2);
    return new $c_T2().init___O__O(name, y)
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
